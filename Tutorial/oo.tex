...
\noindent
\textbf{Remark}:  At this point you might feel a little disappointed because the previous example
...
convenient but not for the sake of nothing.
...
\item First, line 5 defines a method called \texttt{sum}.  Despite the looks of it, this
      ...
      \begin{table}[!hbt]
        ...
        \begin{tabular}[t]{|l|l||l|l|}
          ...
          \hline
          \texttt{*}  & \texttt{product}  & \texttt{!}  & \texttt{not} \\
          \hline
