...
\item \texttt{\qote{x*x}} specifies the function that is plotted.  The string given as argument
      is evaluated for different values of the variable $x$ and the resulting function is the
      plotted. 
\item \texttt{\qote{f(x) = x*x}} is the string that is used as legend in the plot.  This string
...
Lets assume we want to make the $x$-axis and the $y$-axis visible.  For this purpose, the
