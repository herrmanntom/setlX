\chapter{Writing Statements in \setlx}
...
There is a variant syntax for definining function which is appropriate if the definition of the
...
The grammar rule for \texttt{switch} statements is as follows:
\\[0.2cm]
\hspace*{1.3cm}
