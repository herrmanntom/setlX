...
for some years in a number of his introductory computer science courses.  He has 
...
\item \textsc{SetlX} supports terms in a way similar to the language \textsl{Prolog}.  In
      particular, \textsc{SetlX} supports matching.
\item \textsc{SetlX} supports some ideas from functional programming.  In particular,
...
\item \textsc{SetlX} provides some means to support backtracking.
