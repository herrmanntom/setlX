...
\item \textsc{SetlX} supports several ideas from functional programming.  In particular,
      ...
      supports \emph{closures} \cite{landin:1964} and the \emph{memoization} \cite{michie:1968} of functions.
\item \textsc{SetlX} has support for regular expressions.
\item \textsc{SetlX} provides a limited way of backtracking.  This feature was also inspired from
      \textsl{Prolog}.
