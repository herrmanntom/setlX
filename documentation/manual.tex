...
On UNIX (-like) systems, the prompt in interactive mode does not handle control sequences correctly. This is a Java Limitation and no platform independent solutions are available. You may use the `rlwrap' program to work around this issue.
