...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static void init() {
        ...
        frame.setTitle("SetlX Standard Draw");
    ...
    *************************************************************************/
    ...
    private static double  scaleX(final double x) { return width  * (x - xmin) / (xmax - xmin); }
    private static double  scaleY(final double y) { return height * (ymax - y) / (ymax - ymin); }
    private static double factorX(final double w) { return w * width  / Math.abs(xmax - xmin);  }
    private static double factorY(final double h) { return h * height / Math.abs(ymax - ymin);  }
    private static double   userX(final double x) { return xmin + x * (xmax - xmin) / width;    }
    private static double   userY(final double y) { return ymax - y * (ymax - ymin) / height;   }
     ...
     */
    public static void setFont(final Font f) { font = f; }
    ...
    *************************************************************************/
    ...
    public static void interruptWaitingThread(){
        if ( waitingThread != null && waitingThread.isInterrupted() ){
     ...
     * on screen at once).
     * Changed for setlX
     * Reads the slider which can slow down or speed up the animation
    ...
    *************************************************************************/
    ...
    public static void addSpeedSlider( final boolean add ){
    ...
    public static void addPlayPauseButton( final boolean add ){
