...
public class PD_stat_betaCDF_plot extends PreDefinedProcedure {
    ...
    public Value execute(State state, HashMap<ParameterDefinition, Value> args) throws SetlException {
        ...
        return ConnectJFreeChart.getInstance().addListGraph((Canvas) canvas, valueList, "Cumulative Distribution Function (alpha: " + alpha.toString() +" and beta: " + beta.toString() + ")", Defaults.DEFAULT_COLOR_SCHEME, false);
    }
}
