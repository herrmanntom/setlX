...
public class PD_stat_cauchyCDF_plot extends PreDefinedProcedure {
    ...
    public Value execute(State state, HashMap<ParameterDefinition, Value> args) throws SetlException {
        ...
        return ConnectJFreeChart.getInstance().addListGraph((Canvas) canvas, valueList, "Cumulative Distribution Function (mean: " + t.toString() + ", standard deviation: " + s.toString(), Defaults.DEFAULT_COLOR_SCHEME, false);
    }
}
