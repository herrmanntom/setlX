...
public class PD_stat_gamma_plot extends PreDefinedProcedure {
    ...
    public Value execute(State state, HashMap<ParameterDefinition, Value> args) throws SetlException {
        ...
        return ConnectJFreeChart.getInstance().addListGraph((Canvas) canvas, valueList, "Probability Density Function (p: " + p.toString() + ", b: " + b.toString(), Defaults.DEFAULT_COLOR_SCHEME, false);
    }
}
