...
public class PD_stat_levy_plot extends PreDefinedProcedure {
    ...
    public Value execute(State state, HashMap<ParameterDefinition, Value> args) throws SetlException {
        ...
        return ConnectJFreeChart.getInstance().addListGraph((Canvas) canvas, valueList, "Probability Density Function (mu: " + mu.toString() + ", scale: " + scale.toString(), Defaults.createColorScheme(color, state), false);
    }
}
