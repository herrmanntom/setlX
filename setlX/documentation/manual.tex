...
To work around this problem, edit the used launching script (`\command{setlX}' or `\command{win-setlX.cmd}') with a text editor and follow the directions given at the top of the script.
