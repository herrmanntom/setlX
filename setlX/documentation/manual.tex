...
On UNIX systems, the prompt in interactive mode does not handle control sequences correctly. This is a Java Limitation an all workarounds are not platform independent. You may use the `rlwrap' program to work around this issue.
