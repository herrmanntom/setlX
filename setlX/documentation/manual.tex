...
\end{lstlisting}
	...
	\begin{enumerate}
		...
		\item Add a semicolon (`\command{;}') followed by the full path to the folder where you installed \setlX{} to the very end of the string in the `\command{Variable value}' field. The new value should look like:
\begin{lstlisting}[frame=none,numbers=none]
