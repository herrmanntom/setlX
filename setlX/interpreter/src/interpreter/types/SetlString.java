...
public class SetlString extends Value {
    ...
    public int compareTo(Value v){
        ...
        } else if (v instanceof SetlSet || v instanceof SetlList || v instanceof ProcedureDefinition || v == Infinity.POSITIVE) {
            // SetlSet, SetlList, ProcedureDefinition and +Infinity are bigger
            return -1;
        } else {
            return 1;
        }
