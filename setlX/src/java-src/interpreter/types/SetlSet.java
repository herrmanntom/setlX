...
public class SetlSet extends CollectionValue {
    ...
    public MatchResult matchesTerm(Value other) throws IncompatibleTypeException {
        ...
        throw new IncompatibleTypeException("Using lexicographically ordered collections like sets as match condition is unsupported. Try using the isSet() function outside of the match statement.");
    }
