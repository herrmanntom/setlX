...
public class SumAssignment extends Expr {
    ...
    protected Value evaluate() throws SetlException {
        final Value assigned = mLhs.assign(mLhs.eval().sumAssign(mRhs.eval().clone()));
    ...
    public static SumAssignment termToExpr(final Term term) throws TermConversionException {
        if (term.size() != 2) {
