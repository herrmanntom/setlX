 ...
 */
public abstract class CollectionBuilder extends CodeFragment implements Comparable<CollectionBuilder> {
     ...
     */
    @Override
    public abstract int compareTo(final CollectionBuilder other);

    /**
     * In order to compare "incomparable" expressions, e.g. of different subtypes of
     * CollectionBuilder, the return value of this function is used to establish some
