...
public class Modulo extends Expr {
    ...
    /**
     * Convert a term representing a Modulo expression into such an expression.
     *
     ...
     */
    public static Modulo termToExpr(final State state, final Term term) throws TermConversionException {
        if (term.size() != 2) {
