...
public class PD_addPlayPauseButton extends PreDefinedFunction {

    public final static PreDefinedFunction DEFINITION = new PD_addPlayPauseButton();
    
    protected PD_addPlayPauseButton() {
